        ...
        for k in 1:K
            ...
            if g.min_uptime > 1
                ...
                eq_segprod_limit_a[sc.name, gn, t, k] = @constraint(
                    ...
                    base_name = "eq_segprod_limit_a_$(sc.name)_$(gn)_$(t)_$(k)"
                )
            else
                ...
                eq_segprod_limit_b[sc.name, gn, t, k] = @constraint(
                    ...
                    base_name = "eq_segprod_limit_b_$(sc.name)_$(gn)_$(t)_$(k)"
                )
                ...
                eq_segprod_limit_c[sc.name, gn, t, k] = @constraint(
                    ...
                    (t < T ? Cw * switch_off[gn, t+1] : 0.0),
                    base_name = "eq_segprod_limit_c_$(sc.name)_$(gn)_$(t)_$(k)"
                )
            end
            ...
            eq_prod_above_def[sc.name, gn, t] = @constraint(
                ...
                base_name = "eq_prod_above_def_$(sc.name)_$(gn)_$(t)"
            )
